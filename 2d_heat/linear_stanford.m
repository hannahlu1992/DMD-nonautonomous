...
qx_train_in = zeros([N_w,N_snap,size_p1]);
qx_train_out = qx_train_in;
qy_train_in = zeros([N_w,N_snap,size_p1]);
qy_train_out = qx_train_in;
rate_train_in = zeros([1,N_snap,size_p1]);
rate_train_out = rate_train_in;
    ...
    for i2 = 1:size_p1(2)
        for i3 = 1:size_p1(3)
            for i4 = 1:size_p1(4)
                for i5 = 1:size_p1(5)
                    [i1,i2,i3,i4,i5]
                    w_train_in(:,:,i1,i2,i3,i4,i5) = 1+1.*rand([N_w,N_snap]);
                    for n = 1:N_snap
                        [w_train_out(:,n,i1,i2,i3,i4,i5),qx_train_out(:,n,i1,i2,i3,i4,i5),...
                            qy_train_out(:,n,i1,i2,i3,i4,i5),rate_train_out(:,n,i1,i2,i3,i4,i5),...
                            qx_train_in(:,n,i1,i2,i3,i4,i5),qy_train_in(:,n,i1,i2,i3,i4,i5),...
                            rate_train_in(:,n,i1,i2,i3,i4,i5)]= stanford_modified(tau,w_train_in(:,n,i1,i2,i3,i4,i5),...
...
save('train_data.mat',w_train_in,w_train_out,qx_train_in,qx_train_out,qy_train_in,qy_train_out,rate_train_in,rate_train_out);
...
%             for i4 = 1:size_p1(4)
%                 for i5 = 1:size_p1(5)
%                     [ROB_train_dmd(:,:,i1,i2,i3,i4,i5), Kr_train_dmd(:,:,i1,i2,i3,i4,i5),Br_train_dmd(:,i1,i2,i3,i4,i5)] = DMD(w_train_in(:,:,i1,i2,i3,i4,i5),w_train_out(:,:,i1,i2,i3,i4,i5),N_q);
% %                     w_train_dmd(:,:,i1,i2,i3,i4,i5) = ROM_construction(w_train_in(:,:,i1,i2,i3,i4,i5),...
% %                         ROB_train_dmd(:,:,i1,i2,i3,i4,i5), Kr_train_dmd(:,:,i1,i2,i3,i4,i5),Br_train_dmd(:,i1,i2,i3,i4,i5),N_T);
% %                     e_train_dmd(i1,i2,i3,i4,i5) = norm(w_train_out(:,:,i1,i2,i3,i4,i5)-w_train_dmd(:,:,i1,i2,i3,i4,i5))./norm(w_train_out(:,:,i1,i2,i3,i4,i5));
%                 end
%             end
%         end
%     end
